...
export const ESTASIS_CARDS: AnyCard[] = [
  ...
  },
  {
    ...
    updatedAt: FB_TS,
    stats: { cost: 0 },
    efecto: 'Al inicio de tu Alba puedes bloquear 1 Éter de tu Reserva sobre un Campeón sin agotarlo.',
  },
  {
    id: 'FB-022',
    name: 'Último Refugio',
    ...
    updatedAt: FB_TS,
    stats: { cost: 0 },
    efecto: 'La primera vez por turno que un Campeón que controles fuera a ser destruido, no lo es.',
  },
  {
    id: 'FB-023',
...
export const DISONANCIA_CARDS: AnyCard[] = [
  ...
  },
  {
    ...
    updatedAt: DS_TS,
    stats: { cost: 0 },
    efecto: 'Al inicio de tu Alba, un Campeón que controla el rival con Éter bloqueado pierde 1 de ATQ hasta el final del turno.',
  },
  {
    id: 'DS-022',
    ...
    updatedAt: DS_TS,
    stats: { cost: 0 },
    efecto: 'La primera vez por turno que un Campeón que controlas muere, el rival pierde 1 carta de su mano al azar.',
  },
  {
    id: 'DS-023',
    name: 'El Nudo',
